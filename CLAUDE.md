...
All core-dev commands run from `agent-board-core/`:
...
AGENTBOARD_REAPER_TIMEOUT_MS=10000 AGENTBOARD_REAPER_SWEEP_MS=2000 \
  node --experimental-sqlite --no-warnings agent-board-core/server.mjs
