...
async function test(): Promise<void> {
  try {
    ...
    console.log('[TEST] Session keys:', Object.keys(session as object));
    ...
    if (result) {
      console.log('[TEST] result keys:', Object.keys(result as object));
    }

    console.log(
      '[TEST] After send. idleEventFired:',
      idleEventFired,
      'assistantMessageFired:',
      assistantMessageFired,
      'messageEventFired:',
      messageEventFired,
    );
    ...
    console.log(
      '[TEST] After 3s wait. idleEventFired:',
      idleEventFired,
      'assistantMessageFired:',
      assistantMessageFired,
      'messageEventFired:',
