...
import { computeCost, PRICING_VERSION } from '../src/pricing.mjs';
...
describe('Executor & Copilot Support', () => {
  ...
  describe('Executor Provider Resolution', () => {
    it('defaults to claude when no project or task override', () => {
      const task = { agent_provider_override: null };
      const project = { agent_provider: null };
    ...
    it('uses project provider when no task override', () => {
      const task = { agent_provider_override: null };
      const project = { agent_provider: 'github_copilot' };
    ...
    it('task override takes precedence over project default', () => {
      const task = { agent_provider_override: 'claude' };
      const project = { agent_provider: 'github_copilot' };
    ...
    it('task override to copilot takes precedence', () => {
      const task = { agent_provider_override: 'github_copilot' };
      const project = { agent_provider: 'claude' };
    ...
    it('resolution order: task > project > default', () => {
      ...
      const task1 = { agent_provider_override: 'github_copilot' };
      const project1 = { agent_provider: 'claude' };
      ...
      const task2 = { agent_provider_override: null };
      const project2 = { agent_provider: 'github_copilot' };
      ...
      const task3 = { agent_provider_override: null };
      const project3 = { agent_provider: null };
