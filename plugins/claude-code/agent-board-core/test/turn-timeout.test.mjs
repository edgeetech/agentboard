...
import { TurnTimeout, TimeoutError } from '../src/turn-timeout.mjs';
...
describe('TurnTimeout', () => {
  ...
  it('clearing the timeout before it fires does not abort the signal', async () => {
    vi.useFakeTimers();
  ...
  it('signal aborts after timeout fires', async () => {
    vi.useFakeTimers();
    const tt = new TurnTimeout(100);
    tt.start();
