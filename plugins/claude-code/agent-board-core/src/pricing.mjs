...
const COPILOT_FALLBACK   = { input:  1,    output:  3, cache_write:  1.25, cache_read: 0.1 };
const CLAUDE_SONNET_RATE = { input:  3,    output: 15, cache_write:  3.75, cache_read: 0.3 };
const CLAUDE_OPUS_RATE   = { input: 15,    output: 75, cache_write: 18.75, cache_read: 1.5 };
const CLAUDE_HAIKU_RATE  = { input:  0.8,  output:  4, cache_write:  1.0,  cache_read: 0.08 };
const GPT_4_1_RATE       = { input:  2,    output:  8, cache_write:  2.5,  cache_read: 0.5 };
const GPT_5_RATE         = { input:  1.25, output: 10, cache_write:  1.5,  cache_read: 0.125 };
const GPT_5_MINI_RATE    = { input:  0.25, output:  2, cache_write:  0.3,  cache_read: 0.025 };
const O3_RATE            = { input:  2,    output:  8, cache_write:  2.5,  cache_read: 0.5 };
const GEMINI_25_PRO_RATE = { input:  1.25, output: 10, cache_write:  1.5,  cache_read: 0.31 };
...
function lookupPrice(key) {
  ...
  if (stripped !== key && PRICING[stripped]) return PRICING[stripped];
